...
function updateTestimonials() {
    ...
    if (testimonialsGrid) {
        ...
        firstTestimonial.innerHTML = `
            <img src="footage/Ahmed%20Bannout.jpg" loading="lazy" alt="Ahmed Bannout" style="width: 80px; height: 80px; border-radius: 50%; object-fit: cover; margin-bottom: 15px;"/>
        ...
        secondTestimonial.innerHTML = `
            <img src="footage/OleBelisar.jpg" loading="lazy" alt="Ole Belisar" style="width: 80px; height: 80px; border-radius: 50%; object-fit: cover; margin-bottom: 15px;"/>
            <h3 class="grey-text">hear from people i worked with</h3>
        ...
        thirdTestimonial.innerHTML = `
            <img src="footage/DarianWIegand.jpg" loading="lazy" alt="Darian Wiegand" style="width: 80px; height: 80px; border-radius: 50%; object-fit: cover; margin-bottom: 15px;"/>
            <h3 class="grey-text">hear from people i worked with</h3>
        ...
        fourthTestimonial.innerHTML = `
            <img src="footage/Gregor%20Schade.jpg" loading="lazy" alt="Gregor Schade" style="width: 80px; height: 80px; border-radius: 50%; object-fit: cover; margin-bottom: 15px;"/>
            <h3 class="grey-text">hear from people i worked with</h3>
