(function () {
  ...
  function init() {
    ...
    Object.assign(video.style, {
      ...
      opacity: '0',
      mixBlendMode: 'screen',
      maskImage: 'radial-gradient(ellipse 80% 90% at 60% 40%, black 40%, transparent 80%)',
      webkitMaskImage: 'radial-gradient(ellipse 80% 90% at 60% 40%, black 40%, transparent 80%)',
